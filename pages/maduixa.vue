...
<template>
  <main
    class="min-h-screen bg-gradient-to-br from-pink-900 via-black to-pink-800 text-white overflow-x-hidden"
  >
    <!-- Hero Section -->
    <section
    ...
    >
      <!-- Logo maduixa -->
      <div id="maduixa-logo" class="mb-8 relative">
        <div
          class="w-32 h-32 bg-gradient-to-br from-pink-600 to-pink-800 rounded-full flex items-center justify-center shadow-2xl"
        >
          <span class="text-6xl">👙</span>
        </div>
        <div
          class="absolute -inset-4 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full blur-lg opacity-30 animate-pulse"
        ></div>
      </div>
      ...
      <h1
        id="maduixa-title"
        class="text-6xl md:text-8xl lg:text-9xl font-bold mb-6 text-center bg-gradient-to-r from-pink-300 via-rose-300 to-pink-500 bg-clip-text text-transparent"
      >
        LENCERÍA MADUIXA
      </h1>
      ...
      >
        Una experiencia de e-commerce elegante creada con
        <span class="text-pink-400 font-semibold">Nuxt 3</span> y
        <span class="text-pink-400 font-semibold">Laravel</span>
      </p>
      ...
      <a
        ...
        class="px-10 py-5 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full text-white font-semibold text-lg hover:from-rose-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-pink-500/30"
      >
      ...
      <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          >
            ...
            <h3 class="text-xl font-semibold text-green-400 mb-2">Nuxt 3</h3>
          ...
          >
            <div
              class="w-20 h-20 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center mb-6"
            >
              <img
            ...
            <p class="text-gray-400 text-sm text-center">Backend API</p>
          </div>
          ...
          >
            ...
            >
              <img
                src="/img/icons/clerk.svg"
                alt="Autentificación"
                class="w-12 h-12"
              />
            </div>
            <h3 class="text-xl font-semibold text-purple-400 mb-2">Clerk</h3>
            <p class="text-gray-400 text-sm text-center">Autenticación</p>
          </div>
        </div>
      </div>
    </section>
    ...
    >
      <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-2 gap-16">
          ...
          >
            <div
              class="w-20 h-20 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center mb-8"
            >
            ...
            <ul class="space-y-4 text-gray-300 text-lg">
              <li class="flex items-center space-x-4">
                ...
                <span>Catálogo visual elegante</span>
              </li>
              <li class="flex items-center space-x-4">
                <span class="text-pink-400 text-xl">✓</span>
                <span>Galería de imágenes interactiva</span>
              </li>
              <li class="flex items-center space-x-4">
                <span class="text-pink-400 text-xl">✓</span>
                <span>Información detallada de productos</span>
              </li>
              <li class="flex items-center space-x-4">
                <span class="text-pink-400 text-xl">✓</span>
          ...
          >
            <div
              class="w-20 h-20 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-8"
            >
              <span class="text-3xl">⚙️</span>
            </div>
            <h3 class="text-3xl font-bold mb-6 text-purple-400">
            ...
            <ul class="space-y-4 text-gray-300 text-lg">
              ...
              <li class="flex items-center space-x-4">
                <span class="text-pink-400 text-xl">✓</span>
                <span>Gestión de imágenes múltiples</span>
              </li>
              <li class="flex items-center space-x-4">
                <span class="text-pink-400 text-xl">✓</span>
      ...
      <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12">
          <div class="screenshot hover-card group">
            <div class="relative overflow-hidden rounded-2xl">
              <img
                ...
                alt="Vista principal de Maduixa"
          ...
          <div class="screenshot hover-card group">
            <div class="relative overflow-hidden rounded-2xl">
              <img
                src="/img/proyectos/carousel.webp"
              ...
              <div
                class="absolute bottom-4 left-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              >
                <h4 class="font-semibold">Galería</h4>
                <p class="text-sm text-gray-300">Carrusel de imágenes</p>
              </div>
            </div>
          </div>
          ...
          <div class="screenshot hover-card group">
            <div class="relative overflow-hidden rounded-2xl">
              <img
                src="/img/proyectos/muestra.webp"
                alt="Vista móvil"
                class="parallax-img w-full h-64 object-cover transition-transform duration-500 group-hover:scale-110"
              />
              <div
              ...
              <div
                class="absolute bottom-4 left-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              >
                <h4 class="font-semibold">Vista Móvil</h4>
                <p class="text-sm text-gray-300">Experiencia responsive</p>
              </div>
            </div>
          </div>
        </div>
    ...
    >
      <div class="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          tecnología puede crear experiencias de compra elegantes y
          sofisticadas.
        </p>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="px-16 py-6 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full text-white font-semibold text-xl hover:from-rose-600 hover:to-pink-600 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-pink-500/30 hover:scale-105 min-w-[280px] text-center"
          >
            Ver Proyecto Live
          </a>
